...
#plt.show()
class PointTesting():
    def __init__(self, particles, meshbox, r):
        self.meshbox = meshbox
        self.particles = particles
        self.coefficients = meshbox.mpe_coefficients
        print("init mpe coeffs", len(self.coefficients), self.coefficients)
        self.r = r
...
#             if position.all() != self.meshbox.centre.all():
...
#     def plot_difference(self, particles, other_particles, plot_range = [0,0]):
#         xs = []
#         ys = []
...
# def plot_difference(particles, other_particles, plot_range = [0,0]):
#         xs = []
#         ys = []
#         potential_differences = []
#         is_bad = []
